...
async def index():
    ...
    css_tag = '<link rel="stylesheet" href="/static/design-v2.css?v=10">'
    deferred_app = '<script defer src="/static/auth-v2.js?v=10"></script><script defer src="/static/design-v2.js?v=10"></script><script async src="https://telegram.org/js/telegram-web-app.js"></script>'
